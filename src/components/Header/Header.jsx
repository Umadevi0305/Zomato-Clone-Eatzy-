...
import { MdRestaurant, MdKeyboardArrowDown } from "react-icons/md"
  ...
  return (
    <div className="header-container">
      <div className="header">
        ...
        <Link to="/" onClick={() => setDisplayBarOptions(false)} className="logo-link">
  <MdRestaurant className="logo-icon" />
  <span className="logo-text">Eatzy</span>
  <span className="slogan">- Your Hunger, Our Speed!</span>
</Link>
        ...
        <div className="authentications">
          <Link className="link" to="/checkout">
            <span className="cartIcon-total">
              ...
              <span className="cartItemTotal" style={{ color: Object.keys(cartItems).length && "white" }}>
          ...
          {!loginUser ? (
            ...
            <span className="link login-user" onClick={userHandler}>
              ...
              <span className="log-out" style={{ display: displayLogOut && "block" }} onClick={logOutHandler}>
                Log out
              </span>
            </span>
          )}
